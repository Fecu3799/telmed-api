...
- Turnos (crear, cancelar, reprogramar)
- Pagos (MercadoPago) + webhooks
- Chat basico medico-paciente
...
- Historial de turnos y facturacion
- Panel admin con verificacion de doctores
...
- Auditoria y compliance (HIPAA/GDPR)
- Analitica avanzada
