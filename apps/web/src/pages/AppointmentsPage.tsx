...
/**
 * Get date range for appointments list (current month)
 */
...
export function AppointmentsPage() {
  ...
  useEffect(() => {
    const loadAppointments = async () => {
      ...
      try {
        const response: AppointmentsResponse = await listPatientAppointments(
          dateRange.from,
          dateRange.to,
          page,
          20,
            ...
            {appointments.map((appointment) => (
              ...
              >
                <div style={{ marginBottom: '8px' }}>
                  <strong>Fecha:</strong> {formatDateTime(appointment.startAt)}
                </div>
                <div style={{ marginBottom: '8px' }}>
                ...
                {showCancelModal === appointment.id && (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      >
                        {cancellingId === appointment.id ? 'Cancelando...' : 'Confirmar Cancelación'}
                      </button>
                      <button
                        onClick={() => {
                          setShowCancelModal(null);
          ...
          {pageInfo && (pageInfo.hasNextPage || pageInfo.hasPrevPage) && (
            ...
            >
              ...
              <span style={{ color: '#666' }}>
                Página {pageInfo.page} de {Math.ceil(pageInfo.total / pageInfo.limit)}
              </span>
